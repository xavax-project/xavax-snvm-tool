...
impl Default for XavaxTheme {
    fn default() -> XavaxTheme {
        XavaxTheme {
            defaults_style: Style::new().for_stderr().color256(156),
            prompt_style: Style::new().for_stderr().bold(),
            prompt_prefix: style("?".to_string()).for_stderr().color256(191),
            prompt_suffix: style("：".to_string()).for_stderr().color256(191),
            success_prefix: style("✔".to_string()).for_stderr().color256(156),
            success_suffix: style("·".to_string()).for_stderr().color256(156),
            error_prefix: style("⨯".to_string()).for_stderr().red(),
            error_style: Style::new().for_stderr().red(),
            hint_style: Style::new().for_stderr().black().bright(),
            values_style: Style::new().for_stderr().color256(156),
            active_item_style: Style::new().for_stderr().color256(197),
            inactive_item_style: Style::new().for_stderr(),
            active_item_prefix: style("➤".to_string()).for_stderr().color256(191),
            inactive_item_prefix: style(" ".to_string()).for_stderr(),
            checked_item_prefix: style("✔".to_string()).for_stderr().color256(156),
            unchecked_item_prefix: style("✔".to_string()).for_stderr().color256(156),
            picked_item_prefix: style("🢒".to_string()).for_stderr().color256(170),
